...
id: FEAT-029
type: feature
title: "Metadata workflow engine"
epic: EPIC-005
milestone: M6
priority: Critical
effort_days: 8
...
Generalize the workflow rules learned from real Chemistry+Haematology use into configuration.
...
- [ ] A new workflow rule can be added via configuration without a code deployment
- [ ] Existing Chemistry/Haematology hard-coded workflows are correctly migrated to the engine with no behavior change
...
- [ ] Proposal file: `docs/plans/feat-029-metadata-workflow-engine.md`
...
- **Project fields:** Type=Feature, ID=FEAT-029, Epic=EPIC-005, Priority=Critical, Effort=8d, Area=backend, Milestone=M6, Status=Not Started
