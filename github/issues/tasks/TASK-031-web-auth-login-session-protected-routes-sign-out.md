...
id: TASK-031
type: task
title: "Web auth: login, session, protected routes, sign-out"
feature: FEAT-008
epic: EPIC-002
milestone: M2
priority: Critical
...
Login flow in apps/web

## Acceptance criteria

- [ ] Full login → authenticated app → logout flow works correctly in the browser
...
- **Project fields:** Type=Task, ID=TASK-031, Feature=FEAT-008, Priority=Critical, Size=M (1 day), Area=frontend, Milestone=M2, Status=Not Started
