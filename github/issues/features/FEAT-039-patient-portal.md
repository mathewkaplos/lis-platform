...
labels: [type:feature, priority:high, area:frontend, milestone:m8]
status: Not Started
---

# FEAT-039: Patient portal

**Type:** Feature &nbsp;·&nbsp; **Epic:** [`EPIC-007`](../epics/EPIC-007-interoperability-portals.md) — Interoperability & Portals &nbsp;·&nbsp;
**Milestone:** M8 &nbsp;·&nbsp; **Priority:** High &nbsp;·&nbsp; **Effort:** ~6 days &nbsp;·&nbsp; **Status:** Not Started

## Purpose

Direct, policy-gated patient access to their own results.
...
- [ ] A patient can view their own verified results and trends, gated by the configured release policy
...
- [ ] Proposal file: `docs/plans/feat-039-patient-portal.md`
...
`type:feature`, `priority:high`, `area:frontend`, `milestone:m8`

## GitHub metadata

- **Milestone (GitHub):** M8
- **Parent issue:** EPIC-007
- **Project fields:** Type=Feature, ID=FEAT-039, Epic=EPIC-007, Priority=High, Effort=6d, Area=frontend, Milestone=M8, Status=Not Started
