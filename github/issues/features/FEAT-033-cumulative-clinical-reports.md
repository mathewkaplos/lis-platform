...
id: FEAT-033
type: feature
title: "Cumulative & clinical reports"
epic: EPIC-006
milestone: M7
priority: High
effort_days: 5
...
**Milestone:** M7 &nbsp;·&nbsp; **Priority:** High &nbsp;·&nbsp; **Effort:** ~5 days &nbsp;·&nbsp; **Status:** Not Started

## Purpose

Trend/cumulative views clinicians actually need.
...
- [ ] A cumulative report correctly assembles multiple historical results for one patient/analyte
...
- [ ] Proposal file: `docs/plans/feat-033-cumulative-clinical-reports.md`
...
- **Project fields:** Type=Feature, ID=FEAT-033, Epic=EPIC-006, Priority=High, Effort=5d, Area=fullstack, Milestone=M7, Status=Not Started
