...
labels: [type:feature, priority:high, area:backend, milestone:m5]
status: Not Started
---

# FEAT-025: Delta checks

**Type:** Feature &nbsp;·&nbsp; **Epic:** [`EPIC-004`](../epics/EPIC-004-analytical-core.md) — Analytical Core &nbsp;·&nbsp;
**Milestone:** M5 &nbsp;·&nbsp; **Priority:** High &nbsp;·&nbsp; **Effort:** ~2 days &nbsp;·&nbsp; **Status:** Not Started

## Purpose

Catch implausible result changes before they're verified.
...
- [ ] A result exceeding the configured delta threshold from the prior value surfaces an inline plausibility warning
...
- [ ] Proposal file: `docs/plans/feat-025-delta-checks.md`
...
`type:feature`, `priority:high`, `area:backend`, `milestone:m5`

## GitHub metadata

- **Milestone (GitHub):** M5
- **Parent issue:** EPIC-004
- **Project fields:** Type=Feature, ID=FEAT-025, Epic=EPIC-004, Priority=High, Effort=2d, Area=backend, Milestone=M5, Status=Not Started
