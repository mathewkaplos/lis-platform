...
id: TASK-023
type: task
title: "Migration: order, ordered_test, specimen, M:N link"
feature: FEAT-006
epic: EPIC-001
milestone: M1
priority: Critical
...
db/migrations/000X_order_specimen.sql

## Acceptance criteria

- [ ] One specimen correctly fulfils two distinct ordered tests
...
- **Project fields:** Type=Task, ID=TASK-023, Feature=FEAT-006, Priority=Critical, Size=M (1 day), Area=db, Milestone=M1, Status=Not Started
