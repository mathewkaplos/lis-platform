...
id: FEAT-036
type: feature
title: "HL7 v2 inbound/outbound via ACL"
epic: EPIC-007
milestone: M8
priority: Critical
effort_days: 8
...
labels: [type:feature, priority:critical, area:backend, milestone:m8]
status: Not Started
---

# FEAT-036: HL7 v2 inbound/outbound via ACL

**Type:** Feature &nbsp;·&nbsp; **Epic:** [`EPIC-007`](../epics/EPIC-007-interoperability-portals.md) — Interoperability & Portals &nbsp;·&nbsp;
**Milestone:** M8 &nbsp;·&nbsp; **Priority:** Critical &nbsp;·&nbsp; **Effort:** ~8 days &nbsp;·&nbsp; **Status:** Not Started

## Purpose

Interoperate with external EHR/HIS systems.

## Dependencies

- `FEAT-028` — Transactional outbox + event bus
...
- [ ] An inbound HL7 order message correctly creates an order via the anti-corruption layer
- [ ] An outbound ORU result message is correctly generated from a verified Observation
...
- [ ] Proposal file: `docs/plans/feat-036-hl7-v2-inbound-outbound-via-acl.md`
...
`type:feature`, `priority:critical`, `area:backend`, `milestone:m8`

## GitHub metadata

- **Milestone (GitHub):** M8
- **Parent issue:** EPIC-007
- **Project fields:** Type=Feature, ID=FEAT-036, Epic=EPIC-007, Priority=Critical, Effort=8d, Area=backend, Milestone=M8, Status=Not Started
