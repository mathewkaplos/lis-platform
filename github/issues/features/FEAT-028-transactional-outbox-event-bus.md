...
id: FEAT-028
type: feature
title: "Transactional outbox + event bus"
epic: EPIC-005
milestone: M6
priority: Critical
effort_days: 4
...
**Milestone:** M6 &nbsp;·&nbsp; **Priority:** Critical &nbsp;·&nbsp; **Effort:** ~4 days &nbsp;·&nbsp; **Status:** Not Started

## Purpose

Reliable, atomic domain-event emission underlying the workflow engine.
...
- [ ] An event and its triggering state change commit atomically or not at all (outbox pattern verified under failure injection)
...
- [ ] Proposal file: `docs/plans/feat-028-transactional-outbox-event-bus.md`
...
- **Project fields:** Type=Feature, ID=FEAT-028, Epic=EPIC-005, Priority=Critical, Effort=4d, Area=backend, Milestone=M6, Status=Not Started
