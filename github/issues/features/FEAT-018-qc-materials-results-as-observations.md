...
id: FEAT-018
type: feature
title: "QC materials & results as Observations"
epic: EPIC-004
milestone: M5
priority: Critical
effort_days: 5
...
Reuse the result engine for QC control-material results rather than building a parallel system.
...
- [ ] A QC result on a control material persists as an Observation with the correct linkage to the control lot
...
- [ ] Proposal file: `docs/plans/feat-018-qc-materials-results-as-observations.md`
...
- **Project fields:** Type=Feature, ID=FEAT-018, Epic=EPIC-004, Priority=Critical, Effort=5d, Area=backend, Milestone=M5, Status=Not Started
