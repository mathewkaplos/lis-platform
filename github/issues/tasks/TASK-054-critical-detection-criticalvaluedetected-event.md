...
id: TASK-054
type: task
title: "Critical detection + CriticalValueDetected event"
feature: FEAT-015
epic: EPIC-004
milestone: M4
priority: Critical
...
Critical detection in the result pipeline

## Acceptance criteria

- [ ] Golden dataset passes for HH/LL detection including boundary and unit-conversion cases
...
- **Project fields:** Type=Task, ID=TASK-054, Feature=FEAT-015, Priority=Critical, Size=M (1 day), Area=backend, Milestone=M4, Status=Not Started
