...
id: TASK-049
type: task
title: "Range-resolution service + snapshot onto observation"
feature: FEAT-014
epic: EPIC-004
milestone: M4
priority: Critical
...
# TASK-049: Range-resolution service + snapshot onto observation
...
Range-resolution service

## Acceptance criteria

- [ ] Golden dataset passes for all sex/age/method dimensions tested
...
- **Project fields:** Type=Task, ID=TASK-049, Feature=FEAT-014, Priority=Critical, Size=L (2 days), Area=backend, Milestone=M4, Status=Not Started
