...
export interface paths {
    ...
    "/v1/users": {
        ...
        get: operations["UserManagementController_list"];
        put?: never;
        post: operations["UserManagementController_create"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/v1/users/{id}/role": {
        ...
        options?: never;
        head?: never;
        patch: operations["UserManagementController_changeRole"];
        trace?: never;
    };
    "/v1/users/{id}/enabled": {
        parameters: {
...
export interface components {
    schemas: {
        ...
        CreateUserDto: {
            ...
            password: string;
            /** @enum {string} */
            role: "reception" | "technologist" | "pathologist" | "qa" | "cashier" | "lab_admin";
        };
        UpdateUserRoleDto: {
            /** @enum {string} */
            role: "reception" | "technologist" | "pathologist" | "qa" | "cashier" | "lab_admin";
...
export interface operations {
    ...
    UserManagementController_list: {
        ...
        responses: {
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["UserListResponseDto_Output"];
                };
            };
        };
    };
    UserManagementController_create: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    UserManagementController_changeRole: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    UserManagementController_setEnabled: {
        parameters: {
            query?: never;
            header?: never;
            path: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["UpdateUserEnabledDto"];
            };
        };
        responses: {
            200: {
