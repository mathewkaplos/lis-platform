...
id: FEAT-024
type: feature
title: "Peripheral film structured reporting"
epic: EPIC-004
milestone: M5
priority: Medium
effort_days: 3
...
labels: [type:feature, priority:medium, area:fullstack, milestone:m5]
status: Not Started
---

# FEAT-024: Peripheral film structured reporting

**Type:** Feature &nbsp;·&nbsp; **Epic:** [`EPIC-004`](../epics/EPIC-004-analytical-core.md) — Analytical Core &nbsp;·&nbsp;
**Milestone:** M5 &nbsp;·&nbsp; **Priority:** Medium &nbsp;·&nbsp; **Effort:** ~3 days &nbsp;·&nbsp; **Status:** Not Started

## Purpose

Structured (not free-text) morphology grading for blood film review.
...
- §12.2 Peripheral Film

## Acceptance criteria

- [ ] Morphology findings are captured as graded ordinal controls, not a free-text field
...
- [ ] Proposal file: `docs/plans/feat-024-peripheral-film-structured-reporting.md`
...
`type:feature`, `priority:medium`, `area:fullstack`, `milestone:m5`

## GitHub metadata

- **Milestone (GitHub):** M5
- **Parent issue:** EPIC-004
- **Project fields:** Type=Feature, ID=FEAT-024, Epic=EPIC-004, Priority=Medium, Effort=3d, Area=fullstack, Milestone=M5, Status=Not Started
