...
id: FEAT-042
type: feature
title: "AI narrative drafting (advisory)"
epic: EPIC-008
milestone: M9
priority: High
effort_days: 4
...
labels: [type:feature, priority:high, area:ai, milestone:m9]
status: Not Started
---

# FEAT-042: AI narrative drafting (advisory)

**Type:** Feature &nbsp;·&nbsp; **Epic:** [`EPIC-008`](../epics/EPIC-008-governed-ai.md) — Governed AI &nbsp;·&nbsp;
**Milestone:** M9 &nbsp;·&nbsp; **Priority:** High &nbsp;·&nbsp; **Effort:** ~4 days &nbsp;·&nbsp; **Status:** Not Started

## Purpose

Save technologist/pathologist time on routine narrative drafting.
...
- [ ] An AI-drafted narrative is clearly labeled as AI-originated and requires explicit human verification before release
...
- [ ] Proposal file: `docs/plans/feat-042-ai-narrative-drafting-advisory.md`
...
`type:feature`, `priority:high`, `area:ai`, `milestone:m9`

## GitHub metadata

- **Milestone (GitHub):** M9
- **Parent issue:** EPIC-008
- **Project fields:** Type=Feature, ID=FEAT-042, Epic=EPIC-008, Priority=High, Effort=4d, Area=ai, Milestone=M9, Status=Not Started
