...
id: FEAT-031
type: feature
title: "Auto-verification (deny-by-default)"
epic: EPIC-005
milestone: M6
priority: Critical
effort_days: 5
...
# FEAT-031: Auto-verification (deny-by-default)

**Type:** Feature &nbsp;·&nbsp; **Epic:** [`EPIC-005`](../epics/EPIC-005-automation-instruments.md) — Automation & Instruments &nbsp;·&nbsp;
**Milestone:** M6 &nbsp;·&nbsp; **Priority:** Critical &nbsp;·&nbsp; **Effort:** ~5 days &nbsp;·&nbsp; **Status:** Not Started

## Purpose

Safely automate release of in-range, QC-passed results while criticals always route to a human.

## Dependencies

- `FEAT-029` — Metadata workflow engine
...
- [ ] In-range, QC-passed results auto-verify correctly
- [ ] A critical value is never auto-verified under any configuration (Constitution-gated, tested)
- [ ] Auto-verification rules support a dry-run mode before being enabled live
...
- [ ] Proposal file: `docs/plans/feat-031-auto-verification-deny-by-default.md`
...
- **Project fields:** Type=Feature, ID=FEAT-031, Epic=EPIC-005, Priority=Critical, Effort=5d, Area=backend, Milestone=M6, Status=Not Started
