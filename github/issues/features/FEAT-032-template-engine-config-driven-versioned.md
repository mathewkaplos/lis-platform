...
id: FEAT-032
type: feature
title: "Template engine (config-driven, versioned)"
epic: EPIC-006
milestone: M7
priority: Critical
effort_days: 8
...
labels: [type:feature, priority:critical, area:backend, milestone:m7]
status: Not Started
---
...
**Milestone:** M7 &nbsp;·&nbsp; **Priority:** Critical &nbsp;·&nbsp; **Effort:** ~8 days &nbsp;·&nbsp; **Status:** Not Started

## Purpose

Make new tests and report layouts configuration, not a code release — the commercial moat.
...
- [ ] Proposal file: `docs/plans/feat-032-template-engine-config-driven-versioned.md`
...
`type:feature`, `priority:critical`, `area:backend`, `milestone:m7`

## GitHub metadata

- **Milestone (GitHub):** M7
- **Parent issue:** EPIC-006
- **Project fields:** Type=Feature, ID=FEAT-032, Epic=EPIC-006, Priority=Critical, Effort=8d, Area=backend, Milestone=M7, Status=Not Started
