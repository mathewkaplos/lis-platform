...
Expose the structured Observation model as standards-conformant FHIR.
...
- [ ] A FHIR Observation resource generated from an internal Observation validates against the R4 base profile
...
- [ ] Proposal file: `docs/plans/feat-037-fhir-r4-fa-ade.md`
...
- **Project fields:** Type=Feature, ID=FEAT-037, Epic=EPIC-007, Priority=High, Effort=6d, Area=backend, Milestone=M8, Status=Not Started
