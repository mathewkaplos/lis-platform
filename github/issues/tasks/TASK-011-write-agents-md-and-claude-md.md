...
# TASK-011: Write AGENTS.md and CLAUDE.md
...
- [ ] A fresh Claude Code session correctly states the stack, commands, and the five invariants when asked
...
- **Project fields:** Type=Task, ID=TASK-011, Feature=FEAT-003, Priority=Critical, Size=M (1 day), Area=ai, Milestone=M0, Status=Not Started
