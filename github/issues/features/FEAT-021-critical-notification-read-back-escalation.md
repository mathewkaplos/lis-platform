...
id: FEAT-021
type: feature
title: "Critical notification, read-back & escalation"
epic: EPIC-004
milestone: M5
priority: Critical
effort_days: 5
...
# FEAT-021: Critical notification, read-back & escalation
...
The full safety loop: notify, read back, escalate if unacknowledged.
...
- §21.6 Critical Results

## Acceptance criteria

- [ ] Critical detection triggers a notification with a documented, audited read-back requirement
- [ ] Unacknowledged criticals escalate on a timer to a defined escalation contact
...
- [ ] Proposal file: `docs/plans/feat-021-critical-notification-read-back-escalation.md`
...
- **Project fields:** Type=Feature, ID=FEAT-021, Epic=EPIC-004, Priority=Critical, Effort=5d, Area=fullstack, Milestone=M5, Status=Not Started
