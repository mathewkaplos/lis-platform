...
id: TASK-005
type: task
title: "Docker Compose: Postgres 16 + Valkey; db:reset"
feature: FEAT-001
epic: EPIC-001
milestone: M0
priority: Critical
...
Local dev database stack

## Acceptance criteria

- [ ] docker compose up gives a reachable Postgres 16 and Valkey instance
- [ ] pnpm db:reset drops, migrates, and seeds cleanly
...
- **Project fields:** Type=Task, ID=TASK-005, Feature=FEAT-001, Priority=Critical, Size=S (0.5 day), Area=infra, Milestone=M0, Status=Not Started
