...
id: FEAT-026
type: feature
title: "Edge integration gateway"
epic: EPIC-005
milestone: M6
priority: Critical
effort_days: 6
...
labels: [type:feature, priority:critical, area:infra, milestone:m6]
status: Not Started
---
...
**Milestone:** M6 &nbsp;·&nbsp; **Priority:** Critical &nbsp;·&nbsp; **Effort:** ~6 days &nbsp;·&nbsp; **Status:** Not Started

## Purpose

An on-prem-capable gateway for analyzer protocols.
...
- [ ] Gateway deploys and runs on-prem independently of the main application
- [ ] Store-and-forward buffering survives a simulated network interruption
...
- [ ] Proposal file: `docs/plans/feat-026-edge-integration-gateway.md`
...
`type:feature`, `priority:critical`, `area:infra`, `milestone:m6`

## GitHub metadata

- **Milestone (GitHub):** M6
- **Parent issue:** EPIC-005
- **Project fields:** Type=Feature, ID=FEAT-026, Epic=EPIC-005, Priority=Critical, Effort=6d, Area=infra, Milestone=M6, Status=Not Started
