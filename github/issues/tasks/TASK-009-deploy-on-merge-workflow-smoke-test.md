...
id: TASK-009
type: task
title: "Deploy-on-merge workflow + smoke test"
feature: FEAT-002
epic: EPIC-001
milestone: M0
priority: Critical
...
- [ ] A merge to main reaches staging automatically and a smoke test confirms health
...
- **Project fields:** Type=Task, ID=TASK-009, Feature=FEAT-002, Priority=Critical, Size=M (1 day), Area=infra, Milestone=M0, Status=Not Started
