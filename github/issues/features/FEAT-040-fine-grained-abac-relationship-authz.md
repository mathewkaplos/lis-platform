...
id: FEAT-040
type: feature
title: "Fine-grained ABAC / relationship authz"
epic: EPIC-007
milestone: M8
priority: High
effort_days: 5
...
labels: [type:feature, priority:high, area:backend, milestone:m8]
status: Not Started
---

# FEAT-040: Fine-grained ABAC / relationship authz

**Type:** Feature &nbsp;·&nbsp; **Epic:** [`EPIC-007`](../epics/EPIC-007-interoperability-portals.md) — Interoperability & Portals &nbsp;·&nbsp;
**Milestone:** M8 &nbsp;·&nbsp; **Priority:** High &nbsp;·&nbsp; **Effort:** ~5 days &nbsp;·&nbsp; **Status:** Not Started

## Purpose

Support the richer access relationships portals require beyond simple RBAC.

## Dependencies

- `FEAT-009` — Authorization & audit
...
- [ ] A clinician can only access patients with an established care relationship, verified by isolation test
...
- [ ] Proposal file: `docs/plans/feat-040-fine-grained-abac-relationship-authz.md`
...
`type:feature`, `priority:high`, `area:backend`, `milestone:m8`

## GitHub metadata

- **Milestone (GitHub):** M8
- **Parent issue:** EPIC-007
- **Project fields:** Type=Feature, ID=FEAT-040, Epic=EPIC-007, Priority=High, Effort=5d, Area=backend, Milestone=M8, Status=Not Started
