...
labels: [type:feature, priority:critical, area:frontend, milestone:m7]
status: Not Started
---

# FEAT-035: Admin catalog UI

**Type:** Feature &nbsp;·&nbsp; **Epic:** [`EPIC-006`](../epics/EPIC-006-configuration-reporting.md) — Configuration & Reporting &nbsp;·&nbsp;
**Milestone:** M7 &nbsp;·&nbsp; **Priority:** Critical &nbsp;·&nbsp; **Effort:** ~6 days &nbsp;·&nbsp; **Status:** Not Started

## Purpose

Let a lab admin manage tests/ranges/panels without developer involvement.
...
- §20.4 Reference Ranges
- §20.5 Templates

## Acceptance criteria

- [ ] A lab admin can add a new analyte, test, and reference range entirely through the UI
...
- [ ] Proposal file: `docs/plans/feat-035-admin-catalog-ui.md`
...
`type:feature`, `priority:critical`, `area:frontend`, `milestone:m7`

## GitHub metadata

- **Milestone (GitHub):** M7
- **Parent issue:** EPIC-006
- **Project fields:** Type=Feature, ID=FEAT-035, Epic=EPIC-006, Priority=Critical, Effort=6d, Area=frontend, Milestone=M7, Status=Not Started
