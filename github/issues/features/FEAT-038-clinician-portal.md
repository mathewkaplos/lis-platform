...
labels: [type:feature, priority:critical, area:frontend, milestone:m8]
status: Not Started
---

# FEAT-038: Clinician portal
...
Direct clinician access to orders, results, and criticals.

## Dependencies

- `FEAT-033` — Cumulative & clinical reports
...
- §3.8 Doctor Dashboard

## Acceptance criteria

- [ ] A clinician can place an order, view a result, and acknowledge a critical without lab-staff involvement
...
- [ ] Proposal file: `docs/plans/feat-038-clinician-portal.md`
...
`type:feature`, `priority:critical`, `area:frontend`, `milestone:m8`

## GitHub metadata

- **Milestone (GitHub):** M8
- **Parent issue:** EPIC-007
- **Project fields:** Type=Feature, ID=FEAT-038, Epic=EPIC-007, Priority=Critical, Effort=8d, Area=frontend, Milestone=M8, Status=Not Started
