...
id: FEAT-047
type: feature
title: "Visual report designer v1"
epic: EPIC-009
milestone: M10
priority: High
effort_days: 12
...
labels: [type:feature, priority:high, area:frontend, milestone:m10]
status: Not Started
---

# FEAT-047: Visual report designer v1

**Type:** Feature &nbsp;·&nbsp; **Epic:** [`EPIC-009`](../epics/EPIC-009-commercial-readiness.md) — Commercial Readiness &nbsp;·&nbsp;
**Milestone:** M10 &nbsp;·&nbsp; **Priority:** High &nbsp;·&nbsp; **Effort:** ~12 days &nbsp;·&nbsp; **Status:** Not Started

## Purpose

Let a lab admin design report layouts visually rather than via config file.

## Dependencies

- `FEAT-032` — Template engine (config-driven, versioned)
...
- [ ] A lab admin can create and publish a new report layout entirely through the visual designer
...
- [ ] Proposal file: `docs/plans/feat-047-visual-report-designer-v1.md`
...
`type:feature`, `priority:high`, `area:frontend`, `milestone:m10`

## GitHub metadata

- **Milestone (GitHub):** M10
- **Parent issue:** EPIC-009
- **Project fields:** Type=Feature, ID=FEAT-047, Epic=EPIC-009, Priority=High, Effort=12d, Area=frontend, Milestone=M10, Status=Not Started
