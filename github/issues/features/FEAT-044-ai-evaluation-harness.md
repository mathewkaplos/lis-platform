...
# FEAT-044: AI evaluation harness

**Type:** Feature &nbsp;·&nbsp; **Epic:** [`EPIC-008`](../epics/EPIC-008-governed-ai.md) — Governed AI &nbsp;·&nbsp;
**Milestone:** M9 &nbsp;·&nbsp; **Priority:** Critical &nbsp;·&nbsp; **Effort:** ~3 days &nbsp;·&nbsp; **Status:** Not Started

## Purpose

Continuously verify AI outputs are safe and grounded before and after shipping.
...
- [ ] A regression suite of known-good/known-bad prompts runs in CI and flags drift or unsafe output
...
- [ ] Proposal file: `docs/plans/feat-044-ai-evaluation-harness.md`
...
- **Project fields:** Type=Feature, ID=FEAT-044, Epic=EPIC-008, Priority=Critical, Effort=3d, Area=ai, Milestone=M9, Status=Not Started
