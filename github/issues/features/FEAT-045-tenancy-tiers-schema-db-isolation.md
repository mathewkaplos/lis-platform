...
id: FEAT-045
type: feature
title: "Tenancy tiers (schema/DB isolation)"
epic: EPIC-009
milestone: M10
priority: Critical
effort_days: 8
...
**Milestone:** M10 &nbsp;·&nbsp; **Priority:** Critical &nbsp;·&nbsp; **Effort:** ~8 days &nbsp;·&nbsp; **Status:** Not Started

## Purpose

Offer dedicated-schema/DB isolation for larger or data-residency-constrained tenants.
...
- [ ] A tenant can be provisioned onto dedicated schema or database isolation without application code changes
...
- [ ] Proposal file: `docs/plans/feat-045-tenancy-tiers-schema-db-isolation.md`
...
- **Project fields:** Type=Feature, ID=FEAT-045, Epic=EPIC-009, Priority=Critical, Effort=8d, Area=infra, Milestone=M10, Status=Not Started
