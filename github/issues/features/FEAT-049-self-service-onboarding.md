...
labels: [type:feature, priority:high, area:fullstack, milestone:m10]
status: Not Started
---

# FEAT-049: Self-service onboarding

**Type:** Feature &nbsp;·&nbsp; **Epic:** [`EPIC-009`](../epics/EPIC-009-commercial-readiness.md) — Commercial Readiness &nbsp;·&nbsp;
**Milestone:** M10 &nbsp;·&nbsp; **Priority:** High &nbsp;·&nbsp; **Effort:** ~6 days &nbsp;·&nbsp; **Status:** Not Started

## Purpose

Let a new lab sign up and configure itself without your involvement.
...
- [ ] A new tenant can complete the first-time-setup wizard and begin operating without developer intervention
...
- [ ] Proposal file: `docs/plans/feat-049-self-service-onboarding.md`
...
`type:feature`, `priority:high`, `area:fullstack`, `milestone:m10`

## GitHub metadata

- **Milestone (GitHub):** M10
- **Parent issue:** EPIC-009
- **Project fields:** Type=Feature, ID=FEAT-049, Epic=EPIC-009, Priority=High, Effort=6d, Area=fullstack, Milestone=M10, Status=Not Started
