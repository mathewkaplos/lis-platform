...
id: TASK-033
type: task
title: "Audit interceptor on every clinical mutation"
feature: FEAT-009
epic: EPIC-002
milestone: M2
priority: Critical
...
# TASK-033: Audit interceptor on every clinical mutation
...
- [ ] Every clinical write produces exactly one correctly attributed audit_event row
...
- **Project fields:** Type=Task, ID=TASK-033, Feature=FEAT-009, Priority=Critical, Size=M (1 day), Area=backend, Milestone=M2, Status=Not Started
