...
id: TASK-017
type: task
title: "Migration: test_definition, test_analyte, panel"
feature: FEAT-004
epic: EPIC-001
milestone: M1
priority: Critical
...
# TASK-017: Migration: test_definition, test_analyte, panel
...
db/migrations/000X_test_catalog.sql

## Acceptance criteria

- [ ] A CBC panel resolves to its constituent analytes in one query
...
- **Project fields:** Type=Task, ID=TASK-017, Feature=FEAT-004, Priority=Critical, Size=M (1 day), Area=db, Milestone=M1, Status=Not Started
